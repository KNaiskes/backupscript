##########################################################################################################
#Creator: Kiriakos Naiskes 19/8/15
##########################################################################################################
#Run this script as root (sudo script-name won't work!) 
##########################################################################################################
#I am not responsible for any security issue, these rules are the ones I use for my personal servers, 
# ****I AM NOT A SECURITY EXPRERT! ****

import os #for changing mode in startup files

#add -I INPUT -p tcp --dport 80 -j ACCEPT for nginx
